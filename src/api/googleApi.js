...
exports.googleGeocode = async (addressInput) => {
    ...
    if (googleObject) {
        ...
        fullAddress: googleObject.data.results[0].formatted_address,
        ...
        lat: googleObject.data.results[0].geometry.location.lat,
        lng: googleObject.data.results[0].geometry.location.lng
    }
